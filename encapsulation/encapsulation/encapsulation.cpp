...
{
    if (tittle.size()>20)
        throw  std::invalid_argument("le Nom de la fenetre doit comporter "); /*L’instruction throw sert à lancer une exception, c’est-à-dire interrompre le programme normal lorsqu’une erreur critique survient.
